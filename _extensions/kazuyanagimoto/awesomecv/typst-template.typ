...
#let color-olivegreen = rgb("#2e7d32")
...
#let state-color-accent = state("color-accent", color-olivegreen)
  ...
  show heading.where(level: 1): it => [
    ...
    #context {
      align(left)[
        ...
        #box(width: 1fr, line(length: 100%, stroke: 1pt + state-color-accent.get()))
      ]
    }
  ]
